...
class PiePlot
{
    ...
    protected $explode_r             = 20;
        protected $labels; // Array of targets for CSIM
        protected $legends; // Generated CSIM text
        protected $csimtargets; // ALT tags for corresponding target
protected $csimwintargets;
protected $csimareas = '';
protected $csimalts;
    protected $data;
    ...
    protected $show_labels   = true;
        ...
        'sand'   => [27, 168, 34, 170, 19, 50, 65, 72, 131, 209, 46, 393], ]; // Default to percentage
